...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibXVoYW1tYWQtYXJzYWxhbiIsImEiOiJja2J2d2kyZjcwYTl1MzFvYmhia21mYndrIn0.M8_km1PZPC_kgL0Qm9lGPw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/muhammad-arsalan/ckbvwzhjs0ksd1io9scx2vr1v',
    scrollZoom: false
  });
  var bounds = new mapboxgl.LngLatBounds(); //Cretae marker
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extends map to include locations
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'You are logged in successfuly');
...
var stripe = Stripe('pk_test_51H33CDGBsR2GabY7JBZsOKvNFFmYXQ4TkrXNWgVOjS9PlsqptZAl0RWs5iyRImQ7bEhIZ8ADdsIYv68LFuC3PnrW00uz27tOPI');
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; //Destructuring is used as data-tour-id is converted to tourId and e.target returns an array of objects
